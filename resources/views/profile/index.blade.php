            ...
            <div class="flex flex-col max-w-sm p-4 mx-auto lg:max-w-7xl md:max-w-3xl">
                <div class="flex flex-col justify-center mx-auto rounded-lg">
                    ...
                    <p class="text-gray-600">
                        {{ Str::limit(
                            'Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque quae quo provident dolor possimus cupiditate facere mollitia sunt atque, ad consectetur fugiat architecto quidem, maxime iusto e                                                                                                                                                                                 culpa cum harum!',
                            60,
                            '',
                        ) }}
                    </p>
                ...
                <div class="mt-8">
                    ...
                    <div class="flex flex-wrap lg:block lg:flex-nowrap lg:overflow-x-auto lg:whitespace-nowrap">
                        <div class="w-6/12 p-2 lg:w-2/12 lg:inline-block">
                            <img src="{{ asset('img/covers/cover-1.jpg') }}" alt="" class="w-full lg:w-48 h-60">
                        </div>
                        <div class="w-6/12 p-2 lg:w-2/12 lg:inline-block">
                            <img src="{{ asset('img/covers/cover-2.jpeg') }}" alt=""
                                class="w-full lg:w-48 h-60">
                        </div>
                        <div class="w-6/12 p-2 lg:w-2/12 lg:inline-block">
                            <img src="{{ asset('img/covers/cover-3.jpg') }}" alt="" class="w-full lg:w-48 h-60">
                        </div>
                        <div class="w-6/12 p-2 lg:w-2/12 lg:inline-block">
                            <img src="{{ asset('img/covers/cover-4.jpg') }}" alt="" class="w-full lg:w-48 h-60">
                        </div>
                        <div class="w-6/12 p-2 lg:w-2/12 lg:inline-block">
                            <img src="{{ asset('img/covers/cover-4.jpg') }}" alt="" class="w-full lg:w-48 h-60">
                        </div>
                        ...
                        <div class="w-6/12 p-2 lg:w-2/12 lg:inline-block">
                            <img src="{{ asset('img/covers/cover-4.jpg') }}" alt=""
                                class="w-full lg:w-48 h-60">
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-6/12 p-2">
                            <img src="{{ asset('img/covers/cover-1.jpg') }}" alt="" class="w-full h-60">
                            <div class="flex items-center justify-between mt-1">
                                <div>
                                    <span class="block text-sm font-medium">Harus Kembali</span>
                                    <span class="block text-sm italic">21 Februari 2006</span>
                                </div>
                                <form action="#" method="post">
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" class="p-2 bg-blue-500 rounded-full">
                        ...
                        <div class="w-6/12 p-2">
                            <img src="{{ asset('img/covers/cover-2.jpeg') }}" alt="" class="w-full h-60">
                            <div class="flex items-center justify-between mt-1">
                                <div>
                                    <span class="block text-sm font-medium">Harus Kembali</span>
                                    <span class="block text-sm italic">21 Februari 2006</span>
                        ...
                        <div class="w-6/12 p-2">
                            <img src="{{ asset('img/covers/cover-3.jpg') }}" alt="" class="w-full h-60">
                            <div class="flex items-center justify-between mt-1">
                                <div>
                                    <span class="block text-sm font-medium">Harus Kembali</span>
                                    <span class="block text-sm italic">21 Februari 2006</span>
                        ...
                        <div class="w-6/12 p-2">
                            <img src="{{ asset('img/covers/cover-4.jpg') }}" alt="" class="w-full h-60">
                            <div class="flex items-center justify-between mt-1">
                                <div>
                                    <span class="block text-sm font-medium">Harus Kembali</span>
                                    <span class="block text-sm italic">21 Februari 2006</span>
